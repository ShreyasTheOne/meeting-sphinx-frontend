...
class Meeting_details extends Component {
    ...
    render(){
        const { title, organizers, attendees, start_time, end_time, recordings, meeting_id } = this.state
        if (!meeting_id) {
            return (
                <Loader active={'true'} />
            )
            ...
            <div id='details-container'>
                ...
                <div id='details-content-container'>
                    <div id='details-people-info'>
                        ...
                        <People organisers={organizers} attendees={attendees} />
                    </div>
                    {
                    recordings &&
                                    ...
                                    {recordings.map((rec, index) => {
                                        return (
                                            <Table.Row key={index}>
                                                <Table.Cell>
                                                    <Header>
                                                        {/* {console.log(rec.user.full_name)} */}
                                                        {rec.user.full_name}
                                                    </Header>
                                                </Table.Cell>
                                                <Table.Cell>
                                                   {/* { console.log(rec.start_time)} */}
                                                   {/* {rec.start_time} */}
